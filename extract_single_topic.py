...
class Bag:
    ...
    def save_image_topic(self, t, rgb_dir = "images"):
...
if __name__ == '__main__':
    bag = Bag('/home/rmqlife/work/transform/20180119/2018-01-19-00-29-15.bag')
    bag.save_topic(filename='robot_arms',t='/yumi/ikSloverVel_controller/ee_cart_position')
    #bag.save_image_topic(t='/camera/image/rgb_611205001943')
